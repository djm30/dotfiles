...
local close_others = require("setup.config.util").close_others
local close_all = require("setup.config.util").close_all
local close_buffer_without_closing_window = require("setup.config.util").close_buffer_without_closing_window
